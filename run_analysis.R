...
#-------------------------------------------------------------------
# Read in the datasets. This takes a long time.
#-------------------------------------------------------------------
...
# computed. These occur at the following columns (those with ? are
# ones that I wasn't certain whether to include, but my instinct
# was no, so I did not):
# 
# 1 tBodyAcc-mean()-X
# 2 tBodyAcc-mean()-Y
...
# The commented command includes extra columns with "Mean" in
# the names, but currently I am excluding them.
# ColumnIndex = c(1:6,41:46,81:86,121:126,161:166,201,202,214,215,
# 	227,228,240,241,253,254,266:271,294:296,345:350,373:375,
# 	424:429,452:454,503,504,516,517,526,529,530,539,542,543,
# 	552,555:561)
...
# Save Dataset2 in case I need to close R and start over,
# in which case I can pick up here.
write.table(Dataset2,"Dataset Step 2")


#-------------------------------------------------------------------
# If reading in this saved dataset, follow these steps.
# If not, skip to Part 3.
#-------------------------------------------------------------------
Dataset2 = read.table("Dataset Step 2.txt")
features = read.table("features.txt")
activity_labels = read.table("activity_labels.txt")
